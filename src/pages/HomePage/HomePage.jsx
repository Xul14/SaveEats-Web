...
export function HomePage() {
    ...
    useEffect(() => {
        const getProdutosPausados = async () => {
            try {
                const response = await axios.get(`https://save-eats-backend.azurewebsites.net/v1/saveeats/restaurante/produtos-pausados/idRestaurante/${idRestaurante}`);
    ...
    useEffect(() => {
        const getPedidosCancelados = async () => {
            try {
                const response = await axios.get(`https://save-eats-backend.azurewebsites.net/v1/saveeats/restaurante/pedidos-cancelados/idRestaurante/${idRestaurante}`);
    ...
    useEffect(() => {
        const getPedidosAtrasados = async () => {
            try {
                const response = await axios.get(`https://save-eats-backend.azurewebsites.net/v1/saveeats/restaurante/pedidos-atrasados/idRestaurante/${idRestaurante}`);
    ...
    useEffect(() => {
        async function fetchData() {
            try {
                const response = await axios.get(`https://save-eats-backend.azurewebsites.net/v1/saveeats/acompanhamento-desempenho-data-atual/restaurante/idRestaurante/${idRestaurante}`);
    ...
    useEffect(() => {
        const getHorarioFuncionamento = async () => {
            try {
                const response = await axios.get(`https://save-eats-backend.azurewebsites.net/v1/saveeats/restaurante/dia-horario-funcionamento/idRestaurante/${idRestaurante}`);
