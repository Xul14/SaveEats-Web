...
export function AreasEntregaPage() {
    ...
    const handleDeleteFrete = async (id) => {
        try {
            await axios.delete(`https://save-eats-backend.azurewebsites.net/v1/saveeats/frete/area/entrega/id/${id}`);
    ...
    const atualizarDados = async () => {
        try {
            const response = await axios.put("https://save-eats-backend.azurewebsites.net/v1/saveeats/restaurante/raio-entrega", atualizarRaioEntrega)
