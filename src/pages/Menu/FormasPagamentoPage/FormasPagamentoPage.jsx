...
export function FormasPagamentoPage() {
    ...
    //         try {
    //             const formasPagamento = await axios.get('https://save-eats-backend.azurewebsites.net/v1/saveeats/obter-dados-do-mercado-pago');
    ...
    useEffect(() => {
        async function formaPagamentoData() {
            try {
                const formasPagamento = await axios.get('https://save-eats-backend.azurewebsites.net/v1/saveeats/forma/pagamento');
