...
export function FinanceiroPage() {
    ...
    useEffect(() => {
        async function fetchData() {
            try {
                const response = await axios.get(`https://save-eats-backend.azurewebsites.net/v1/saveeats/valor-total-liquido-comissao/restaurante/idRestaurante/${idRestaurante}`);
    ...
    useEffect(() => {
        async function fetchData() {
            try {
                const response = await axios.get(`https://save-eats-backend.azurewebsites.net/v1/saveeats/acompanhamento-desempenho-mes-atual/restaurante/idRestaurante/${idRestaurante}`);
    ...
    useEffect(() => {
        async function fetchDataGrafico() {
            try {
                const response = await axios.get(`https://save-eats-backend.azurewebsites.net/v1/saveeats/pedidos-cancelados-entregues-mes-atual/restaurante/idRestaurante/${idRestaurante}`);
