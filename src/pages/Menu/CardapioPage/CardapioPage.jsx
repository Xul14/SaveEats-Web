...
export function CardapioPage() {
    ...
    useEffect(() => {
        async function produtoData() {
            try {
                ...
                const produto = await axios.get(`https://save-eats-backend.azurewebsites.net/v1/saveeats/restaurante/produtos/nome-fantasia/${nomeRestaurante}`);
    ...
    const buscarProdutos = async () => {
        try {
            const response = await axios.get(`https://save-eats-backend.azurewebsites.net/v1/saveeats/restaurante/produtos/id-restaurante/${idRestaurante}/nome-produto/${termoPesquisa}`);
    ...
    const handleDeleteProduto = async (id) => {
        try {
            await axios.delete(`https://save-eats-backend.azurewebsites.net/v1/saveeats/produto/id/${id}`);
