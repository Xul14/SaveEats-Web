...
export function HorarioFuncionamentoPage() {
    ...
    useEffect(() => {
        async function fetchDiasSemana() {
            try {
                const response = await axios.get('https://save-eats-backend.azurewebsites.net/v1/saveeats/dia/semana');
    ...
    const handleSaveModal = async (data) => {
        ...
        if (data.id) {
            ...
            if (diaSemanaAtual) {
                ...
                try {
                    const response = await axios.put(`https://save-eats-backend.azurewebsites.net/v1/saveeats/restaurante/dia-horario-funcionamento`, dadosAtualizados);
            ...
            try {
                const response = await axios.post(`https://save-eats-backend.azurewebsites.net/v1/saveeats/restaurante/dias-horario-funcionamento`, novoHorario);
