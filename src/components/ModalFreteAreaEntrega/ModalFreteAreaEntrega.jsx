        ...
        if (isEditing) {
            try {
                const response = await axios.put(
                    `http://localhost:8080/v1/saveeats/frete/area/entrega/id/${idAreaEntrega}`,
                    novaAreaEntrega,
                    {
                        headers: {
                ...
                const response = await axios.put(`http://localhost:8080/v1/saveeats/frete/area/entrega/id/${idAreaEntrega}`)
                console.log(response);
